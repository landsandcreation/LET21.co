          ...
          <ul>
            ...
            <li className="border-b border-gray-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-gray-800">Edit your information the profile settings</span> All other information would be sent to your m</span>
            ...
            <li className="border-b border-gray-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">🚀<span className="font-medium text-gray-800">All notification would be reflected in your dashboard</span> Additional information would be sent to your email</span>
